...
int remodelFunc(int currentPlayer, int choice1, int choice2, struct gameState *state, int handPos){
	int i;
...
int salvagerFunc(int currentPlayer, struct gameState* state, int choice1, int handPos){
	//+1 buy
    state->numBuys++;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case remodel:
		remodelFunc(currentPlayer, choice1, choice2, state, handPos);
		return 0;
    ...
    case salvager:
		salvagerFunc(currentPlayer, state, choice1, handPos);
		return 0;
